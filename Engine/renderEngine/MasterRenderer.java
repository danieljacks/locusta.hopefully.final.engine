...
public class MasterRenderer {
	...
	private AnimatedModelRenderer animatedEntityRenderer;

	protected MasterRenderer(EntityRenderer entityRenderer, SkyboxRenderer skyRenderer, WaterRenderer waterRenderer, WaterFrameBuffers waterFbos, ShinyRenderer shinyRenderer, AnimatedModelRenderer animatedEntityRenderer) {
		this.entityRenderer = entityRenderer;
		this.skyRenderer = skyRenderer;
		this.waterRenderer = waterRenderer;
		this.waterFbos = waterFbos;
		this.shinyRenderer = shinyRenderer;
		this.animatedEntityRenderer = animatedEntityRenderer;
	}
	...
	private void renderMainPass(Scene scene){
		prepare();
		animatedEntityRenderer.render(scene.getAnimatedEntities(), scene.getCamera(), scene.getLightDirection());
